...
st.markdown("""
    <style>
    .day-header-box {
        background-color: #f1f3f5; color: #212529 !important; text-align: center;
        font-weight: 900; padding: 8px; border-radius: 6px; margin-bottom: 12px;
        border: 1px solid #dee2e6; box-shadow: 1px 1px 3px rgba(0,0,0,0.1);
    }
    @media (prefers-color-scheme: dark) {
        .day-header-box { background-color: #343a40; color: #f8f9fa !important; border: 1px solid #495057; }
    }
    .date-tag-normal {
        background-color: #212529; color: #ffffff !important; padding: 2px 10px;
        border-radius: 4px; font-weight: 800; display: inline-block; margin-bottom: 5px;
    }
    .date-tag-holiday {
        background-color: #fa5252; color: #ffffff !important; padding: 2px 10px;
        border-radius: 4px; font-weight: 800; display: inline-block; margin-bottom: 5px;
    }
    ...
    .turn-box {
        background-color: #fff9db; border-left: 8px solid #fab005; padding: 12px;
        border-radius: 8px; color: #212529 !important; margin-bottom: 15px;
    }
    @media (prefers-color-scheme: dark) {
        .turn-box { background-color: #2b2f36; border-left: 8px solid #f08c00; color: #ffffff !important; }
    }
    .absent-badge {
        color: #e03131; font-weight: bold; background-color: #fff5f5; padding: 1px 5px;
        border-radius: 4px; font-size: 0.8rem; margin-left: 5px; border: 1px solid #ffc9c9;
    }
    </style>
...
st.divider()
if st.session_state.slots:
    st.download_button("💾 12인 당직표 엑셀 저장", data=make_excel(), file_name=f"CARE팀_{sel_month}월_12인당직표.xlsx", use_container_width=True, type="primary")